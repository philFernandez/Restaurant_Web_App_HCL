document.addEventListener("DOMContentLoaded", (e) => {
  ...
  submitBtn.addEventListener("click", (e) => {
    ...
    msgWindow.document.write('<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-giJF6kkoqNQ00vy+HMDP7azOuL0xtbfIcaT9wjKHr8RbDVddVHyTfAAsrekwKmP1" crossorigin="anonymous"/>')
    ...
    msgWindow.document.write("<div class='text-center'><button class='btn btn-primary' type='button' onclick='window.close();'>Close</button</div>");
